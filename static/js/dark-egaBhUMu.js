import{ae as R,c as f,ba as se,a9 as U,m as q,s as Q,Q as h,p as g,a3 as p,U as ue,r as H,bb as le,a0 as P,bc as Y,bd as ie,d as C,h as b,be as ce,bf as j,a_ as de,aY as fe,aR as me,J as he,bg as ge,bh as pe,P as ve,ad as be,a4 as Te,$ as ye,a8 as $e,aE as S,bi as Ce,R as F,g as J,i as K,j as B}from"./index-BLs8DBz_.js";function Se(){const{$storage:t,$config:e}=R(),o=()=>{se().multiTagsCache&&(!t.tags||t.tags.length===0)&&(t.tags=U),t.layout||(t.layout={layout:(e==null?void 0:e.Layout)??"vertical",theme:(e==null?void 0:e.Theme)??"light",darkMode:(e==null?void 0:e.DarkMode)??!1,sidebarStatus:(e==null?void 0:e.SidebarStatus)??!0,epThemeColor:(e==null?void 0:e.EpThemeColor)??"#409EFF",themeColor:(e==null?void 0:e.Theme)??"light",overallStyle:(e==null?void 0:e.OverallStyle)??"light"}),t.configure||(t.configure={grey:(e==null?void 0:e.Grey)??!1,weak:(e==null?void 0:e.Weak)??!1,hideTabs:(e==null?void 0:e.HideTabs)??!1,hideFooter:e.HideFooter??!0,showLogo:(e==null?void 0:e.ShowLogo)??!0,showModel:(e==null?void 0:e.ShowModel)??"smart",multiTagsCache:(e==null?void 0:e.MultiTagsCache)??!1,stretch:(e==null?void 0:e.Stretch)??!1})},n=f(()=>t==null?void 0:t.layout.layout),r=f(()=>t.layout);return{layout:n,layoutTheme:r,initStorage:o}}const ke=q({id:"pure-app",state:()=>{var t,e;return{sidebar:{opened:((t=h().getItem(`${p()}layout`))==null?void 0:t.sidebarStatus)??g().SidebarStatus,withoutAnimation:!1,isClickCollapse:!1},layout:((e=h().getItem(`${p()}layout`))==null?void 0:e.layout)??g().Layout,device:ue()?"mobile":"desktop",viewportSize:{width:document.documentElement.clientWidth,height:document.documentElement.clientHeight}}},getters:{getSidebarStatus(t){return t.sidebar.opened},getDevice(t){return t.device},getViewportWidth(t){return t.viewportSize.width},getViewportHeight(t){return t.viewportSize.height}},actions:{TOGGLE_SIDEBAR(t,e){const o=h().getItem(`${p()}layout`);t&&e?(this.sidebar.withoutAnimation=!0,this.sidebar.opened=!0,o.sidebarStatus=!0):!t&&e?(this.sidebar.withoutAnimation=!0,this.sidebar.opened=!1,o.sidebarStatus=!1):!t&&!e&&(this.sidebar.withoutAnimation=!1,this.sidebar.opened=!this.sidebar.opened,this.sidebar.isClickCollapse=!this.sidebar.opened,o.sidebarStatus=this.sidebar.opened),h().setItem(`${p()}layout`,o)},async toggleSideBar(t,e){await this.TOGGLE_SIDEBAR(t,e)},toggleDevice(t){this.device=t},setLayout(t){this.layout=t},setViewportSize(t){this.viewportSize=t},setSortSwap(t){this.sortSwap=t}}});function X(){return ke(Q)}const Me=q({id:"pure-epTheme",state:()=>{var t,e;return{epThemeColor:((t=h().getItem(`${p()}layout`))==null?void 0:t.epThemeColor)??g().EpThemeColor,epTheme:((e=h().getItem(`${p()}layout`))==null?void 0:e.theme)??g().Theme}},getters:{getEpThemeColor(t){return t.epThemeColor},fill(t){return t.epTheme==="light"?"#409eff":"#fff"}},actions:{setEpThemeColor(t){const e=h().getItem(`${p()}layout`);this.epTheme=e==null?void 0:e.theme,this.epThemeColor=t,e&&(e.epThemeColor=t,h().setItem(`${p()}layout`,e))}}});function _(){return Me(Q)}const N={themeLinkTagId:"theme-link-tag",themeLinkTagInjectTo:"head",multipleScopeVars:[{scopeName:"layout-theme-light",varsContent:`
